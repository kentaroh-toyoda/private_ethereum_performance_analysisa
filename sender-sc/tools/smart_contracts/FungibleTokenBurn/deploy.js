...
yargs.command('$0', 'Deploy FungibleToken', {
  ...
  // 1. compile
  const inputs = {
    'SafeMath.sol': fs.readFileSync('./FungibleToken/contracts/lib/SafeMath.sol', 'utf8'),
    'FungibleToken.sol': fs.readFileSync('./FungibleToken/contracts/FungibleToken.sol', 'utf8')
  }

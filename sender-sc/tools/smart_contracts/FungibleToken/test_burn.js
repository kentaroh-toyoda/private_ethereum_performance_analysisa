...
yargs.command('$0', 'Test FungibleToken Burn', {
	'from': {
		alias: 's',
		default: 0,
  ...
  'totalSupply': {
    alias: 't',
    default: 10000,
    describe: 'Initial value of total supply'
  }
}, async (argv) => {
	console.log('> Testing...')
	...
	await pMap(nonces, burn, { concurrency: Infinity })
